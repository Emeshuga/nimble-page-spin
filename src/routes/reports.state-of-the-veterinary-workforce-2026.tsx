    ...
    >
      ...
      <div className="mt-4 grid gap-3">
        <input
          ...
          className="rounded-full border border-border bg-background px-3 py-2.5 text-sm outline-none ring-ring focus:ring-2"
        />
        <input
          type="email"
          name="email"
        ...
        <button
          type="submit"
          className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground transition hover:opacity-90"
        >
