      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl">
            ...
            <span className="text-primary">Estados Unidos</span>. Nosotros tramitamos tu
            Licencia y Visa.
          </h1>
          <p className="mt-6 text-lg text-muted-foreground sm:text-xl">
            Multiplica tu salario ejerciendo tu pasión. Si eres egresado de la{" "}
            <strong className="text-foreground">FMVZ-UNAM (2011–2025)</strong>, tienes un
            proceso acelerado para comenzar este mismo año.
          </p>
    ...
    <section className="mx-auto max-w-6xl px-4 py-16">
      ...
      >
        ...
        <p className="mt-3 max-w-3xl text-base text-foreground/80 sm:text-lg">
          Tienes una ventaja única. Puedes <strong>saltarte el proceso ECFVG</strong>.
          Estás a un solo examen de distancia de ejercer en EE.UU.
        </p>
        <a
          href="#formulario"
...
function FormSection() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const vip =
      form.universidad === "FMVZ-UNAM" && year >= 2011 && year <= 2025;
    ...
    const { error: err } = await (supabase as any).from("candidates").insert(payload);
    ...
    return (
      <section id="formulario" className="mx-auto max-w-3xl px-4 py-24">
        <div className="rounded-3xl border border-border bg-card p-10 text-center shadow-sm">
          ...
          <h2 className="mt-6 text-2xl font-bold sm:text-3xl">¡Gracias! Recibimos tu perfil.</h2>
          {isVip && (
          ...
          <p className="mt-4 text-muted-foreground">
            Un coordinador se pondrá en contacto contigo por WhatsApp en las próximas{" "}
            <strong className="text-foreground">24 horas</strong> para agendar tu evaluación
            personalizada.
          </p>
        </div>
      </section>
    ...
    <footer className="border-t border-border bg-card">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-8 sm:flex-row">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          © {new Date().getFullYear()} VetBridge USA. Todos los derechos reservados.
        </div>
